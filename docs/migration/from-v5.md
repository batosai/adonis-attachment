...
2. Generate an application-specific data migration script with `node ace make:attachment-v5-migration`. The command renders the package migration stub so the application can complete its legacy model mapping.
