...
test('keeps Lucid exports out of the package root', async ({ assert }) => {
  ...
  assert.notProperty(lucidExports, 'LucidJsonAttachmentStore')
  assert.notProperty(lucidExports, 'LucidJsonAttachmentRegistry')
  assert.notProperty(lucidExports, 'LucidJsonVariantGenerationService')
  assert.notProperty(lucidExports, 'JsonAttachmentEntry')
  assert.notProperty(lucidExports, 'JsonAttachmentRecord')
})
