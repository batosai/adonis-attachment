...
The same 15 tests run on each server: schema creation and foreign-key upgrades,
...
**Oracle AI Database 26ai Free 23.26.3.0.0 passes the 15 tests.** Its integration uses:
...
**SQL Server 2022 Developer 16.0.4275.2 passes the 15 tests.** Its integration uses:
